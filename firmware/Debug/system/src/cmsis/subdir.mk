...
S_UPPER_SRCS += \
../system/src/cmsis/startup_stm32l452xx.S 

OBJS += \
./system/src/cmsis/startup_stm32l452xx.o \
./system/src/cmsis/system_stm32l4xx.o 

S_UPPER_DEPS += \
./system/src/cmsis/startup_stm32l452xx.d 
...
system/src/cmsis/%.o: ../system/src/cmsis/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wall -Wextra  -g3 -x assembler-with-cpp -DDEBUG -DUSE_FULL_ASSERT -DTRACE -DOS_USE_TRACE_SEMIHOSTING_DEBUG -DUSE_HAL_DRIVER -DHSE_VALUE=8000000 -DSTM32L452xx -I"../include" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/cmsis/device" -I"../system/include/stm32l4xx" -I"../Middlewares/ST/STM32_USB_Device_Library/Core/Inc" -I"../Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
